...
import { OCUPACOES_POR_GRUPO, CodigoOcupacao } from '../../domain/carne-leao/ocupacao.model';
...
export class Perfil implements OnInit, OnDestroy {
  ...
  readonly ufs = UFS;
  readonly gruposOcupacao = OCUPACOES_POR_GRUPO;
  ...
  perfilForm = new FormGroup({
    ...
    ocupacao: new FormControl<CodigoOcupacao>('', [Validators.required]),
  });
  ...
  async salvarPerfil() {
    ...
    try {
      ...
      const perfilSalvo = await this.perfilService.salvar({
        ...
        ocupacao: this.perfilForm.value.ocupacao || undefined,
